...
enum igd9x_intel_mmio_reg {
    ...
    IGD9X_INTEL_MMIO_PP_STATUS = 0xC7200UL,
    IGD9X_INTEL_MMIO_PP_CONTROL = 0xC7204UL,
    IGD9X_INTEL_MMIO_PP_ON_DELAYS = 0xC7208UL,
    IGD9X_INTEL_MMIO_PP_OFF_DELAYS = 0xC720CUL,
    IGD9X_INTEL_MMIO_PP_DIVISOR = 0xC7210UL,
    IGD9X_INTEL_MMIO_LVDS_CTL = 0xE1180UL,
...
#define IGD9X_INTEL_PANEL_POWER_ENABLE  0x80000000UL
#define IGD9X_INTEL_LVDS_ENABLE         0x80000000UL
